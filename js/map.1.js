...
var url = "xml/interactive-map-offered-practices.xml",
    ...
    while (i < $rad.length) {
        if ($radInputName[i].checked) {
            ...
            case "alleycroppingLabel": //Alley Cropping Selection
                ...
                $(".alleycroppingLabel").css("border-color", alleyCroppingColor);
            ...
            case "multistoryLabel": //Multistory Cropping Selection
                $(".multistoryLabel").css("border-color", multiStoryColor);
            ...
            case "riparianLabel": //Riparian Forest Buffers Selection
                $(".riparianLabel").css("border-color", riparianColor);
            ...
            case "silvopastureLabel": //Silvopasture Selection
                $(".silvopastureLabel").css("border-color", silvopastureColor);
            ...
            case "windbreaksLabel": //Windbreak Establishment Selection
                $(".windbreaksLabel").css("border-color",windbreakColor);
            ...
            case "windbreakrenovationLabel": //Windbreak Renovation Selection
                $(".windbreakrenovationLabel").css("border-color", windbreakRenoColor);
